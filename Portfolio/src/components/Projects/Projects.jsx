...
import AlgoImage from '../../assets/Algo-visual.png'; // Adjust the relative path
import PortfolioImage from '../../assets/Portfolio.png'; // Import Portfolio.png
    ...
    return (
        <section id="Projects" className="Projects-section">
            ...
            <div className="card-container">
                {/* First Project: Algorithm Visualizer */}
                <div className="project-card">
                    <article className="project">
                        <img className="project-img" src={AlgoImage} alt="Photo of Algorithm Visualizer website" />
                    </article>
                ...
                <div className="project-card">
                    <article className="project">
                        <img className="project-img" src={PortfolioImage} alt="Photo of Portfolio website" />
                    </article>
